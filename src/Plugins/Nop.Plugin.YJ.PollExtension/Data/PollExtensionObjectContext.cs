...
{
    class PollExtensionObjectContext : DbContext, IDbContext
    {
        public PollExtensionObjectContext(DbContextOptions<PollExtensionObjectContext> options) : base(options)
        {
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(PollAnswerMap));
        }
    }
}
